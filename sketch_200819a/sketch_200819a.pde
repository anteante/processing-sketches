...
int scale = 50; // 100 = actual scale 

// enable or disable sorting directions
...
void setup() {
  img = loadImage("IMG_4714.jpeg");
  img.resize((img.width/100)*scale, (img.height/100)*scale);
